                    ...
                    <div className="row content">
                        ...
                        <div className="col-md-8 pt-5 order-2 order-md-1" dataAos="fade-up">
                            ...
                            <ul style={{listStyle:'none'}}>
                                <li><i className="bi bi-asterisk"></i> Silver Plan: $350  for 20 hours (Average $17.50/hour)</li>
                                <li><i className="bi bi-asterisk"></i> Gold Plan: $650 for 40 hours (Average $16.25/hour).
                                </li>
                            </ul>
