        ...
        <div className="row">
          <div className="col-12 d-flex justify-content-center">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="login" style={{width:'400px'}} >
              ...
              <div className="row">
                <div className='col-12 col-md-3'> <button type="submit" className="btn btn-primary login-btn w-100">Login</button></div>
                ...
                <div className='col-12 col-md-8'><button onClick={signInWithGoogle} className="btn bsb-btn-xl btn-secondary login-google-btn w-100">
