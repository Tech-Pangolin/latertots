                                ...
                                <div className="card mb-4">
                                    <div className="card-body">
                                        <blockquote className=" ">
                                            ...
                                            <h5>A Heartfelt Thank You to Amber</h5>
                                            <p className=" m-0 text-muted ">
                                                Amber, words can't express how grateful I am for the love and care you showed my grandson. You truly went above and beyond, not only nurturing him with such dedication but also taking extra time to support him outside of your care. Your warmth, humility, and kindness stood out from the very start, and I could always trust you completely because of your genuine nature. What you see is what you get with Amber, and that's rare.
                                            </p>
                                            <p className=" m-0 text-muted ">
                                                I often wish you were closer so I could have someone like you to care for my other grandchildren when my kids need a break. You were the best then, and I have no doubt you still are. Your dedication to children is a gift, and I pray you continue to be blessed in all that you do.
                                            </p>
                                            <p className=" m-0 text-muted ">
                                                Thank you again, Amber, for being such a light in our lives.
                                            </p>
                                ...
                                <div className="card mb-4">
                                    <div className="card-body">
                                        <blockquote className=" ">
                                            ...
                                            <p className="m-0 text-muted ">What stands out the most for me is how she treated my son. She went above and beyond, not just as a caregiver but as someone who genuinely invested in his happiness, growth, and development. She was there for the little victories, the tough days, and everything in between, always offering her support with a smile.
                                            </p>
                                            <p className="m-0 text-muted ">We were incredibly lucky to have her in our lives. Thank you for being such a positive influence and for all the love and care you’ve shown to every child you work with. </p>
