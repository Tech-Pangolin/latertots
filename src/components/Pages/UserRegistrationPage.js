    ...
    <div className="container">
      <div className="row content">
        <div className="col order-2 order-md-1" >
          ...
          <div className="row">
            <div className="col-12 col-md-12 register-text">
              <p className="text-center">Joining the Later Tots fun is as easy as drop, play, and stay!</p>
              ...
              <p className="text-center">Let’s get ready to giggle, explore, and create lasting memories! </p>
            </div>
